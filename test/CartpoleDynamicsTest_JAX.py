...
from CartPole import cartpole_dynamics_batched_jax
from SymplecticRK4_JAX import symplectic_rk4_step_jax

params = jnp.array([1.0, 0.1, 1.0, 0.01, 9.81], dtype=jnp.float32)
batch_size = 1000
dt = 0.002
T = 10.0
steps = int(T/dt)
...
def run_simulation_memory_efficient(x0, u, dt, params, steps):
    ...
    def body_fun(i, val):
        state, t = val
        state, t = symplectic_rk4_step_jax(cartpole_dynamics_batched_jax, state, t, u, dt, params)
        return state, t
